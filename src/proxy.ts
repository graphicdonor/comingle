...
export async function proxy(request: NextRequest) {
  ...
  // Protected routes
  const protectedPaths = ["/communities/create", "/posts/create", "/settings", "/notifications", "/signup-details", "/pin", "/select-communities", "/profile/edit", "/services/matrimonial", "/services/businesses/register", "/services/jobs/register", "/services/events/register", "/reels"];
